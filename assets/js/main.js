...
sr.reveal(`.about__image,.skills__content:nth-child(2),.mobile,.project__description`,{origin: 'right'});

sr.reveal(`.about__data,.skills__content:nth-child(1),.desktop`,{origin: 'left'});
